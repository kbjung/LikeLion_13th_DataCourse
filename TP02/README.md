...
- 주제 : 2019년 1-3월 가스공급량 예측(2013-2018년 데이터로 훈련, 2019년 1-3월 가스공급량 예측 정확도를 높인다.)
...
- 팀장 : 가채원
- 부팀장 : **김범중** 📢
  - 역할 : 데이터 수집 및 전처리, 분석, 모델 비교 및 개선, 결과 종합, 발표 자료 작성 및 정리
- 팀원 : 김진연, 윤진훈
- 팀 이미지
...
+ 배운 점
  - 결과 예측에 적절한 특성을 선택하는 것이 중요. 많은 특성은 오히려 예측 성능을 떨어트림.
  - 모델 하이퍼 파라미터 조정시 경험과 꼼꼼함이 중요.
  - 다양한 모델의 결과 종합이 효과적.
