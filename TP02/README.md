...
## 가스 공급량과 시간별 기온 데이터 확보(약 36만8천개)
  ...
  + 03 기온 데이터 웹 크롤링
      - webdriver, bs, np, pd 활용 ver0.1(2021.10.21) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.1(2021.10.21).html)
      - 날짜, 기온 인덱스 확인 ver0.2(2021.10.23) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.2(2021.10.23).html)
      - 연도별 크롤링, 결측값 처리 테스트 ver0.3(2021.10.23) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.3(2021.10.23).html)
      - 연도별 크롤링 함수화, 특정 년, 월 크롤링 ver0.4(2021.10.23) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.4(2021.10.23).html)
      - 2014년 6월13일부터 날짜, 기온 인덱스 변경확인됨 ver0.5(2021.10.23) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.5(2021.10.23).html)
      - 2014/6/13~ 변경 인덱스 처리완료(2021.10.24) ver0.6 [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.6(2021.10.24).html)
      - colab에서 크롤링(컴 사양 문제)(2021.10.24) ver0.6 [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.6(colab)(2021.10.24).html)
      - 일별 크롤링 함수화 완료(2021.10.24) ver0.6.1 [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-01_데이터_크롤링_ver0.6.1(2021.10.24).html)
      - 날짜순 정렬, 기온 데이터 숫자형으로 변환(2021.10.25) ver.0.1 [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/03-02_기온값_숫자형변환_ver0.1(2021.10.25).html)
  + 04 가스 공급량과 기온 데이터 출력
    - 가스 공급량과 기온 셋 합침(2021.10.25) ver0.1 [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/04_가스_기온_합치기_ver0.1(2021.10.25).html)
...
## 가스 공급량과 시간별 기온 데이터 전처리
  + 05 결측값 처리
    - 기온 데이터 결측값 확인, 처리 방법 테스트 ver0.1(2021.10.27) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/05_2019년_결측치_처리_ver0.1(2021.10.27).html)
    - 기온 결측치 같은 날짜의 기온 평균으로 처리 함수화, 각 해의 마지막 일(원 사이트에서 없는 자료)의 기온 바로 전시간 기온으로 처리 ver0.3(2021.10.28) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/05_2019년_결측치_처리_ver0.3(2021.10.28).html)
...
## 2019년 기온 예측과 공급량 예측
  ...
  + 07 공급량 예측 출력
    ...
    - 랜덤포레스트 회귀 모델로 기온, 공급량 예측 ver0.1(2021.11.04) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/07-02_결과_출력(random_forest)_ver0.1(2021.11.04).html)
    - 랜덤포레스트 회귀 +평가지표 평가 ver0.2(2021.11.04) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/07-02_결과_출력(random_forest)_ver0.2(2021.11.04).html)
