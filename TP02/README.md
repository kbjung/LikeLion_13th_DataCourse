...
## 2019년 기온 예측과 공급량 예측
  ...
  + 07 공급량 예측 출력 [폴더](https://github.com/kbjung/LikeLion_13th_DataCourse/tree/main/TP02/07_%EA%B2%B0%EA%B3%BC_%EC%B6%9C%EB%A0%A5)
    ...
    - 랜덤포레스트 회귀 에측과 CatBoost 회귀 예측의 평균 ver0.1(2021.11.08) [code(html)]()
    - 랜덤포레스트 회귀 에측과 CatBoost 회귀 예측의 평균(정규화, 표준화, 다항특성, 특성선택-50% 적용) ver0.2(2021.11.09) [code(html)]()
    - 랜덤포레스트 회귀 에측과 CatBoost 회귀 예측의 평균(다항특성 적용) ver0.3(2021.11.09) (제출 ) [code(html)]()
