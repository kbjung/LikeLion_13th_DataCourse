...
## 2019년 기온 예측과 공급량 예측
  ...
  + 07 공급량 예측 출력(pycaret) [폴더](https://github.com/kbjung/LikeLion_13th_DataCourse/tree/main/TP02/07_%EA%B2%B0%EA%B3%BC_%EC%B6%9C%EB%A0%A5)
    ...
    - 43.특성 7개, top3 평균 / cat+lgbm 평균, robust, 이상치(0.1), 튜닝X, final X, log, 구분별 ver3.4(2021.12.07) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/07_결과_출력/07-05_결과_출력(pycaret)_ver3.4(2021.12.07).html)
    - 44.특성 7개, top3 평균 / cat+lgbm 평균, robust, 구분2만 이상치(0.1) 나머지 이상치(기본), 튜닝X, final X, log, 구분별 ver3.5(2021.12.07) [code(html)](https://kbjung.github.io/LikeLion_13th_DataCourse/TP02/07_결과_출력/07-05_결과_출력(pycaret)_ver3.5(2021.12.07).html)
...
| 34 | X | 기본 + 'weekday', '기온', '기압', '습도' | top3 블랜드, 튜닝X, final X, log, 구분별, 이상치 제거(0.1) | X | 0.02539 | 0.96779 |
| 35 | X | 기본 + 'weekday', '기온', '기압', '습도' | top3 평균, 튜닝X, final X, log, 구분별, 이상치 제거(0.1) | X | 0.02275 | 0.98309 |
...
| 38 | X | 기본 + 'weekday', '기온', '기압', '습도' | top2 평균, cat/lgbm 평균, 튜닝X, final X, log, 구분별, robustscaler | X | 0.01738 | 0.98886 |
| 39 | X | 기본 + 'weekday', '기온', '기압', '습도' | top2 평균, cat/lgbm 평균, 튜닝X, final X, log, 구분별, robustscaler, 이상치 제거 | X | 0.01738 | 0.98886 |
| 40 | X | 기본 + 'weekday', '기온', '기압' | top2 평균, cat/lgbm 평균, 튜닝X, final X, log, 구분별, robust | X | 0.01800 | 0.98884 |
| 41 | X | 기본 + 'weekday', '기온', '기압' | top2 평균, cat/xgb 평균, 튜닝X, final X, log, 구분별, robust | X | 0.01854 | 0.98886 |
| 42 | X | 기본 + 'weekday', '기온', '기압', '습도' | top2 평균, cat/xgb 평균, 튜닝X, final X, log, 구분별, robust | X | 0.01758 | 0.98933 |
| 43 | X | 기본 + 'weekday', '기온', '기압', '습도' | top3 평균, cat/lgbm 평균, 수치형 특성지정, 이상치제거(0.1), 튜닝X, final X, log, 구분별 | X | 0.01512 | 0.99120 |
| 44 | - | 기본 + 'weekday', '기온', '기압', '습도' | top3 평균, cat/lgbm 평균, 수치형 특성지정, robust, 이상치 제거(구분2만 0.1), 튜닝X, final X, log, 구분별 | - | 0.01522 | 0.99114 |
